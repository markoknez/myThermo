...
#define I2C_MASTER_SDA_MUX OLED_SDA_MUX
#define I2C_MASTER_SCL_MUX OLED_SCL_MUX
#define I2C_MASTER_SDA_GPIO OLED_SDA_GPIO
#define I2C_MASTER_SCL_GPIO OLED_SCL_GPIO
#define I2C_MASTER_SDA_FUNC OLED_SDA_FUNC
#define I2C_MASTER_SCL_FUNC OLED_SCL_FUNC
