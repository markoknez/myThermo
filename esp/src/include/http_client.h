...
#ifndef IOT_DEMO_INCLUDE_HTTP_CLIENT_H_
#define IOT_DEMO_INCLUDE_HTTP_CLIENT_H_
 ...
 */
void ICACHE_FLASH_ATTR http_post(const char * url, const char *post_method, const char * post_data, const char * headers, http_callback user_callback);
...
#endif /* IOT_DEMO_INCLUDE_HTTP_CLIENT_H_ */
