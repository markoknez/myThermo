...
static ICACHE_FLASH_ATTR uint8_t u8g_com_esp8266_ssd_start_sequence(u8g_t *u8g)
{
	return 0;
...
uint8_t ICACHE_FLASH_ATTR u8g_com_esp8266_hw_spi_fn(u8g_t *u8g, uint8_t msg, uint8_t arg_val, void *arg_ptr)
{
	return 0;
//    switch(msg)
//    {
...
uint8_t ICACHE_FLASH_ATTR u8g_com_esp8266_ssd_i2c_fn(u8g_t *u8g, uint8_t msg, uint8_t arg_val, void *arg_ptr)
{
//    switch(msg)
//    {
//    case U8G_COM_MSG_INIT:
