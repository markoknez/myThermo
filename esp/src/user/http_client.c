...
void ICACHE_FLASH_ATTR http_raw_request(const char * hostname, int port, bool secure, const char * path, const char *post_method, const char * post_data, const char * headers, http_callback user_callback)
{
  PRINTF("DNS request\n");
  ...
  req->post_method = esp_strdup(post_method);
 ...
 */
ICACHE_FLASH_ATTR
void http_post(const char * url, const char *post_method, const char * post_data, const char * headers, http_callback user_callback)
{
  ...
  PRINTF("port=%d\n", port);
  PRINTF("path=%s\n", path);
  http_raw_request(hostname, port, secure, path, post_method, post_data, headers, user_callback);
}

void ICACHE_FLASH_ATTR http_get(const char * url, const char * headers, http_callback user_callback)
{
  http_post(url, NULL, NULL, headers, user_callback);
}
